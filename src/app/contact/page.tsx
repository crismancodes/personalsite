...
const linkClass =
  "inline-flex items-center gap-2 text-[#1c1917] underline focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 rounded";
    ...
    <Section className="pt-8 md:pt-10">
      <Container className="max-w-2xl">
        ...
        <ul className="mt-10 space-y-4">
          ...
          <li>
            <a
              href="https://github.com/crismancodes"
              target="_blank"
              rel="noopener noreferrer"
              className={linkClass}
            >
          ...
          <li>
            <a
              href="/Sean-Crisman-Resume.pdf"
              download="Sean-Crisman-Resume.pdf"
              className={linkClass}
            >
              <DescriptionIcon className="h-6 w-6 shrink-0" />
              Download resume
            </a>
          </li>
        </ul>
